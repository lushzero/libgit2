...
static git_merge_result *merge_simple_branch(int flags, git_merge_strategy_resolve_options *resolve_options)
{
	...
	cl_git_pass(git_merge(&result, repo, (const git_commit **)their_commits, 1, flags, git_merge_strategy_resolve, resolve_options));
...
void test_merge_simple__theirs(void)
{
    ...
    /* TODO: automergeable.txt should be automerged: f2e1550a0c9e53d5811175864a29536642ae3821 */
